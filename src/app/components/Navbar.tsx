...
const Navbar: React.FC = () => {
	...
	return (
		<Container className={`fixed left-1/2 transform -translate-x-1/2 pt-5 2xl:pt-14 xl:pt-10 `}>
			<div
				className={`absolute inset-0 w-full transform transition-transform duration-300 -z-10 ${
					isMenuOpen ? 'translate-x-0 bg-slate-950' : 'translate-x-full bg-transparent'
				}`}
			></div>
